	...
	public function onCommand(CommandSender $sender, Command $command, $label, array $args){
		switch($command->getName()){
			...
			case "info":
			   ...
			   $sender->sendMessage("§7∘ §a§c1§f0§d2§ePE thành lập ngày §b××/××/×××× §avà cũng là ngày mở cửa chính thức");
			   ...
			   $sender->sendMessage("§7∘ §6Survival – Sinh Tồn [Sắp Mở]");
		...
		$sender->sendMessage("§f> §bLobby: ×××");
		$sender->sendMessage("§f> §bAcidIsland: ×××");
		$sender->sendMessage("§f> §bSkyBlock: ×××");
		$sender->sendMessage("§f> §bSurvival: ×××");
		$sender->sendMessage("§o§9▃§b▃§a▃§e▃§6▃§c▃§4▃§2▃§d▃§f▃§7▃§8▃§5▃§1▃§0▃");
		return true;
			default:
			   return false;
