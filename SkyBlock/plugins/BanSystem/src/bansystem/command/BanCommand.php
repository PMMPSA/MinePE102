        ...
        if ($this->testPermissionSilent($sender)) {
            ...
            if (count($args) == 1) {
                if ($player != null) {
                    ...
                    $player->kick(TextFormat::RED . "Bạn đã bị cấm vào máy chủ.", false);
                ...
                if ($player != null) {
                    ...
                    $player->kick(TextFormat::RED . "Bạn đã bị cấm vào máy chủ vì " . TextFormat::AQUA . $reason . TextFormat::RED . ".", false);
                    $playerName = $player->getName();
                } else {
