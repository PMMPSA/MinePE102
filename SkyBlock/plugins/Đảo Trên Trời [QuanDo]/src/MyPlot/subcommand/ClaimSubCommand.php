...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
			...
			$player->getInventory()->addItem(Item::get(4, 0, 10));
			$player->getInventory()->addItem(Item::get(2, 0, 10));
			$player->getInventory()->addItem(Item::get(6, 0, 4));
			$player->getInventory()->addItem(Item::get(17, 0, 32));
			$player->getInventory()->addItem(Item::get(265, 0, 32));
			$player->getInventory()->addItem(Item::get(264, 0, 32));
            $sender->sendMessage("§2SkyBlock §f- Đã thêm §bNước §fvà §eRào §fvào túi đồ của bạn");
        } else {
