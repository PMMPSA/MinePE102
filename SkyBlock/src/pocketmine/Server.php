...
§b=•>§e___  ____           §c __ §f _____ §d _____ §e______ _____ 
§b=•>§e|  \/  (_)          §c/  |§f|  _  |§d/ __  \§e| ___ \  ___|
§b=•>§e| .  . |_ _ __   ___§c`| |§f| |/' |§d`' / /'§e| |_/ / |__  
§b=•>§e| |\/| | | '_ \ / _ \§c| |§f|  /| |§d  / /  §e|  __/|  __| 
§b=•>§e| |  | | | | | |  __/§c| |§f\ |_/ /§d./ /___§e| |   | |___ 
§b=•>§e\_|  |_/_|_| |_|\___§c\___/§f\___/ §d\_____/§e\_|   \____/

	§b=•>§aPhiên bản core: §6" . $this->getPocketMineVersion() . ' (' . $this->getShortGitCommit() . ')§f
	§b=•>§aPhiên bản game: §b' . $version . '§f
	§b=•>§aPhiên bản PHP: §e' . PHP_VERSION . '§f
	§b=•>§aHệ điều hành: §6' . PHP_OS .'§f
	§b=•>§aCore được lập trình bởi PTK-KienPham
	§b=•>§aĐược phát hành độc quyền cho máy chủ §6Mine§c1§f0§d2§ePE
	§b=•>§aCấm sao chép dưới mọi hình thức
	§b=•>§aNếu có lỗi xảy ra hãy liên hệ https://fb.com/Mine102PEDev
	';
	...
	public function start(){
		...
		if(!file_exists($this->getPluginPath() . DIRECTORY_SEPARATOR . "Mine102PE"))
			@mkdir($this->getPluginPath() . DIRECTORY_SEPARATOR . "Mine102PE");
