...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
            ...
            $sender->sendMessage("§9[§c1§f0§d2§ePE§b-§6AcidIsland§9] §aĐã Thêm§b Nước§a Và§6 Dung Nham§a Vào Kho Đồ Của Bạn");
            $sender->sendMessage("§9[§c1§f0§d2§ePE§b-§6AcidIsland§9] §c Hãy cẩn thận với nước vì nó chính là a xít(Acid)");
        } else {
