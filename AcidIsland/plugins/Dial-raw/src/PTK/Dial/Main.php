	...
	public function onCommand(CommandSender $sender, Command $cmd, $label, array $args) {
		...
		if($cmd->getName() == "dial") {
			if($sender instanceof Player){
				...
				switch($rand){
					case 1:
					$sender->sendMessage(T::AQUA ."§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:"  . T::YELLOW. " Chúc mừng bạn đã trúng được cúp sắt");
					...
					break;
					case 18:
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T ::YELLOW. " Chúc mừng bạn đã trúng được cúp vàng");
					...
					break;
					case 31:
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Chúc mừng bạn đã trúng được cúp kim cương");
					...
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Chúc mừng bạn đã trúng được 5 diamond");
					...
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Chúc mừng bạn đã trúng được 5 Iron");
					...
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Chúc mừng bạn đã trúng được 5 Gold Ingot");
					...
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Bạn là người may mắn nhất bạn đã trúng full set Diamond");
					...
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " Chúc mừng bạn đã trúng được Full Set Gold");
					...
					break;
					default:
					$sender->sendMessage(T::AQUA . "§b[§c1§f0§d2§ePE§6-§aQuay Thưởng§b]:" . T::YELLOW. " bạn không may mắn trong ngày hôm nay rồi");
					break;
				}
				}else{
