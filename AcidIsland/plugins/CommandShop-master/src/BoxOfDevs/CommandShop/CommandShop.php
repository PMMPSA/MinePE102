...
class CommandShop extends PluginBase implements Listener{
     ...
     const PREFIX = TF::YELLOW . "§b[§aBuy§eCommand§9System§b]" . TF::WHITE . " ";
     const ERROR = TF::YELLOW . "§b[§aBuy§eCommand§9System§b]" . TF::RED . " [Lỗi]" . TF::WHITE . " ";
     ...
     public function sendUsage(string $cmd, $p): string{
          $p->sendMessage(self::ERROR . "Sử dụng: /cshop $cmd " . $this->usages[$cmd]);
          return true;
     }
                    ...
                    switch($subcmd){
                         case "add":
                              ...
                              if(!isset($cmds[$name])){
                                   ...
                                   $sender->sendMessage(self::PREFIX . "Tên: " . $name);
                                   $sender->sendMessage(self::PREFIX . "Lệnh: " . $cmd);
                                   $sender->sendMessage(self::PREFIX . "Xin hãy đặt giá bán bằng lệnh " . TF::AQUA . "/cshop setprice" . TF::WHITE . ". Or add more commands to be executed using " . TF::AQUA . "/cshop addcmd" . TF::WHITE . ".");
                              }else{
                         ...
                         case "list":
                              ...
                              if($cmds != []){
                                   ...
                                   $sender->sendMessage(self::PREFIX . "Danh sách các lệnh được bán:");
