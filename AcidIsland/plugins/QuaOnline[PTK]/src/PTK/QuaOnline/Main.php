...
class Main extends PluginBase implements Listener{
	public function onEnable(){
		...
		$this->config = new Config($this->getDataFolder(). "config.yml", Config::YAML, array("first_join" => "§f[§l§eQuà Online§r§f]: Ngày đầu tiên Online bạn nhận được §eKiếm kim cương§f với phù phép: §esắc nét", "daily_join" => "§f[§l§eQuà Online§r§f]: §a§l{player}§r§f bạn đã Online liên tiếp §a{count}§f ngày!"));
		$this->players = new Config($this->getDataFolder(). "players.yml", Config::YAML, array());
		$this->reward = new Config($this->getDataFolder(). "reward.yml", Config::YAML, array('1' => array('type' => 'item', 'id' => 276, 'meta' => 0, 'count' => 1, 'custom_name' => 'Quà Online', 'enchant' => array('ench_id' => 9, 'ench_level' => 10))));
		$this->getServer()->getLogger()->info(F::GREEN. "Plugin Quà Online đã kích hoạt!");
	}
