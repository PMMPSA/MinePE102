...
class MainLogger extends \AttachableThreadedLogger {
	...
	protected function send($message, $level, $prefix, $color){
		...
		$message = TextFormat::toANSI(TextFormat::AQUA . "[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[" . $threadName . "§b=<§9•§b>=§r" . $color . $prefix . "]:" . " " . $message . TextFormat::RESET);
		//$message = TextFormat::toANSI(TextFormat::AQUA . "[Mine102PE]->[" . date("H:i:s", $now) . "] " . TextFormat::RESET . $color . "[$prefix]:" . " " . $message . TextFormat::RESET);
